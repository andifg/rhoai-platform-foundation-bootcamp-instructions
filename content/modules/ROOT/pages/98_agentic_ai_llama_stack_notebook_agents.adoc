...
- `type` (Model setting) - Reffers to the selected sampling strategy used by the model. link:https://www.redhat.com/en/products/ai/agentic-ai[RH Agentic AI][Read more.]
